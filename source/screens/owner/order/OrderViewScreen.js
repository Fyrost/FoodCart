...
class OrderViewScreen extends Component {
  ...
  renderButton = () => {
    ...
    if (
      ...
      status === "pending"
        ? {text : "Accept Order", color : '#00CC66', iconName : 'check', iconType : 'font-awesome'} 
        : status === "processing"
          ? {text:"Deliver Order", color: '#11CDEF', iconName: 'local-shipping', iconType: 'material'}
          : {text:"Complete", color: '#00CC66', iconName: 'check-square-o', iconType: 'font-awesome'};
    const stopButtonTitle = 
      status === "pending" 
        ? {text:"Reject Order", color: '#EF1B17', iconName: 'times', iconType: 'font-awesome'} 
        : {text:"Cancel Order", color: 'orange', iconName: 'cancel', iconType: 'material-community'};
    return (
      ...
      <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-evenly' }}>
        <Button
          ...
          buttonStyle={{ flex: 1, borderRadius: 0, backgroundColor: proceedButtonTitle.color }} 
        ...
        <Button
          ...
          buttonStyle={{ flex: 1, borderRadius: 0, backgroundColor: stopButtonTitle.color }} 
          containerStyle ={{ flex: 1 }} 
  ...
  renderItem = ({ item: { id, name, cooking_time, quantity } }) => (
    <View>
      <View style={{ paddingHorizontal: 10, paddingVertical: 5, backgroundColor: '#5999C8' }}>
        <Text style={{ color: 'white', fontSize: 18, fontWeight: '500'  }}>Menu: {name}</Text>
      </View>
      <View style={{ justifyContent: 'space-evenly', paddingHorizontal: 10, paddingVertical: 10, borderColor: "gray", borderBottomWidth: 0.5 }}>
        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
          <Text style={{ fontWeight: '500', fontSize: 16 }}>Cook Time: </Text>
          <Text style={{ fontWeight: 'normal', fontSize: 16 }}>{cooking_time} mins</Text>
        </View>
        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
      ...
      <View style={{ flex: 1 }}>
        ...
        <View style={{ flex: 4, borderColor: "gray", borderTopWidth: 1, justifyContent: "center" }}>
          ...
          <View style={{ alignItems: 'center', paddingVertical: 10, backgroundColor: '#5999C8' }}>
            <Text style={{ color: 'white', fontSize: 16, fontWeight: '500'  }}>Billing Information</Text>
          </View>
