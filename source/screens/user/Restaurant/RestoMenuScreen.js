...
class RestoViewScreen extends Component {
  ...
  renderRestoClose = () => {
    <View style={stylesResto.headerRowClose}>
      <Text style={{ fontSize: 28, fontWeight: '700', color: 'white' }}>CLOSED</Text>
    </View>
  }
  ...
  renderRestoDetail = () => (
    <View style={{ display: this.state.loading ? "none" : "flex", flex: 1 }}>
          ...
          >
            <View style={{ flex: 2 }}>
              ...
              <View style={{ flex: 1, alignItems: "center" }}>
                ...
                <Text style={stylesResto.headerRating}>
                  {this.state.votes}
                </Text>
              </View>
            </View>
      ...
      { !this.state.restoOpen && 
        this.renderRestoClose()
      }
      <View style={stylesResto.headerBottomContainer}>
        ...
        {!this.state.rateVisible?<View style={stylesResto.ratingContainer}>
          <Rating
            showRating
            fractions={1}
